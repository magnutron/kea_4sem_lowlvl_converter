...
# 5 "converter.c" 2
# 1 "weight_converters.c" 1
float kilograms_to_ounces(float kilograms) {
...
float ounces_to_kilograms(float ounces) {
    return ounces / 35.274;
}

float ounces_to_pounds(float ounces) {
    return ounces / 16;
}
...
float pounds_to_ounces(float pounds) {
    return pounds * 16;
}
# 6 "converter.c" 2
# 1 "weight_ui.c" 1
